...
void oscEvent(OscMessage theOscMessage) {
  if (theOscMessage.checkAddrPattern("/wek/outputs") == true) {
      ...
      int f1 = (int)theOscMessage.get(0).floatValue();
      int f2 = (int)theOscMessage.get(1).floatValue();
      int f3 = (int)theOscMessage.get(2).floatValue();
      
      if (f3 == 2 && f3Previous != 2) {
        jump();
      }
      if (f1 == 2 && f1Previous != 2) {
        goLeft();
      }
      if (f2 == 2 && f2Previous != 2) {
        goRight();
      }
      if (oneMoveMax) {
          f1Previous = f1;
